    ...
    return (
        ...
        <div className={styles.container} style={{ overflow: 'auto' }}>
            ...
            <div className={styles.main_container}>
                <div className={styles.main_row1} style={{ fontFamily: "cute", fontSize: "30px", fontWeight: "600" }} onClick={() => { navigate('/') }}>WANNA</div>
                <div className={styles.main_row2}>
                    <input placeholder='가고싶은 곳을 찾아보세요.' style={{ fontSize: "20px", height: '25px', width: "80vw", }} />
                    <img src='images/search.svg' style={{ height: '25px', marginRight: "5px", fontSize: "50px" }} />
                    <Buttons />
                </div>
                ...
                <div className={styles.main_row5}>
                    <div className={styles.place_container}>
                        ...
                        <div className={styles.sub_container1}>
                            <div className={styles.sub_col1}>
                                <ListGroup variant="flush">
                                    <ListGroup.Item onClick={() => { set서울(!서울) }}>서울</ListGroup.Item>
                                    {
                                        서울 == true ? <Modal서울 /> : null
                                    }
                                    <ListGroup.Item onClick={() => { set인천(!인천) }}>인천</ListGroup.Item>
                                    {
                                        인천 == true ? <Modal인천 /> : null
                                    }
                                    <ListGroup.Item onClick={() => { set경상(!경상) }}>경상</ListGroup.Item>
                                    {
                                        경상 == true ? <Modal경상 /> : null
                                    }
                                    <ListGroup.Item onClick={() => { set강원(!강원) }}>강원</ListGroup.Item>
                                    {
                                        강원 == true ? <Modal강원 /> : null
                                    }
                                    <ListGroup.Item onClick={() => { set제주(!제주) }}>제주</ListGroup.Item>
                                    {
                            ...
                            <div className={styles.sub_col2}>
                                <ListGroup variant="flush">
                                    <ListGroup.Item onClick={() => { set경기(!경기) }}>경기</ListGroup.Item>
                                    {
                                        경기 == true ? <Modal경기 /> : null
                                    }
                                    <ListGroup.Item onClick={() => { set부산(!부산) }}>부산</ListGroup.Item>
                                    {
                                        부산 == true ? <Modal부산 /> : null
                                    }
                                    <ListGroup.Item onClick={() => { set전라(!전라) }}>전라</ListGroup.Item>
                                    {
                                        전라 == true ? <Modal전라 /> : null
                                    }
                                    <ListGroup.Item onClick={() => { set충청(!충청) }}>충청</ListGroup.Item>
                                    {
                ...
                <div className={styles.main_row6}>
                    <h3 onClick={() => { navigate('/ReviwBoard') }}>베스트 리뷰</h3>
                    <Review_image />
                </div>
            </div>
        </div >
